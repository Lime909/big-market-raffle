...
public enum ResponseCode {
    ...
    ACTIVITY_QUOTA_ERROR("ERR_BIZ_006","账户总额度不足"),
    ACTIVITY_MONTH_QUOTA_ERROR("ERR_BIZ_007","账户月额度不足"),
    ACTIVITY_DAY_QUOTA_ERROR("ERR_BIZ_008","账户日额度不足"),
