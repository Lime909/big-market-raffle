...
public class ActivityRepository implements IActivityRepository {
    ...
    public void updateOrder(DeliveryOrderEntity deliveryOrderEntity) {
        ...
        try {
            ...
            raffleActivityAccountMonth.setCreateTime(raffleActivityOrderRes.getCreateTime());
            raffleActivityAccountMonth.setUpdateTime(raffleActivityOrderRes.getUpdateTime());
            ...
            raffleActivityAccountDay.setCreateTime(raffleActivityOrderRes.getCreateTime());
            raffleActivityAccountDay.setUpdateTime(raffleActivityOrderRes.getUpdateTime());
